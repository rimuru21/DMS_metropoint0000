...
<div class="row">
	...
	<div classc="col-md-8" style=" width:60%;">
        <span class="pull-left"><a style="padding:8px; border-radius:4px ;margin-bottom:.5em; "href="#addnew_eng_type" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-left:.5em"></span> Add Bus Eng. Type</a></span>
		...
		<span class="pull-left"><a style="padding:8px; border-radius:4px ;margin-bottom:.5em; margin-left:.5em; "href="#addnew_bus" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-left:.5em"></span> Add Bus</a></span>
...
<div class="col-md-4">
<div>
	<div style="width:100%;margin-left:50em;margin-top:-36.4em; margin-bottom:0em">
		<div style="height:10px;"></div>
				<table class="table table-striped table-bordered table-hover" id="myTable">
						<thead style="display: block; overflow: hidden; word-break: break-word;border-bottom:1px solid white;padding-bottom:10px; padding-top:10px">
						...
						<tbody style="display: block;overflow:auto; width: 100%;height: 175px; word-break: break-word; scrollbar-width: none; border-bottom:1px solid white">
							<?php
								include('conn.php');
								
								$query=mysqli_query($conn,"SELECT * FROM `bus_eng_type`");
								while($row=mysqli_fetch_array($query)){
									?>
				...
				<table class="table table-striped table-bordered table-hover" id="myTable">
						...
						<tbody style="display: block;overflow:auto; width: 100%;height: 175px; word-break: break-word; scrollbar-width: none; border-bottom:1px solid white">
							<?php
								...
								$query=mysqli_query($conn,"SELECT * FROM `bus_type`");
								while($row=mysqli_fetch_array($query)){
									?>
									<tr style="border-bottom:1px solid white;margin-bottom:5px;height:50px">
