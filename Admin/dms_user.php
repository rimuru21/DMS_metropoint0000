...
<div class="row">
	...
	<div class="" style=" width:90%;">
		...
		<span class="pull-right"><a style="padding:8px; margin-right:.5em; border-radius:4px  "href="#addnew_dri" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Driver</a></span>

		<span class="pull-right"><a style="padding:8px; margin-right:.5em; border-radius:4px  "href="#addnew_dispatch" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Dispatcher</a></span>

		<span class="pull-right"><a style="padding:8px; margin-right:.5em; border-radius:4px; margin-bottom:.5em;  "href="#addnew_opertr" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Operator</a></span>
				...
				<table class="table table-striped table-bordered table-hover" id="myTable" >
						...
						<tbody style="display: block;overflow:auto; width: 100%;height: 405px; word-break: break-word; scrollbar-width: none; border-bottom:1px solid white">
							<?php
								...
								WHERE a.stat_id = b.stat_id AND a.type_id = c.type_id AND a.ter_id =d.ter_id
