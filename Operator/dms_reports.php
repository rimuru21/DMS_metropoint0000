	...
	<div>
        <ul class="menu-bar">
            ...
            <li style="left:.4em;font-family: 'Source Sans Pro';"><a href="dms_ter_reports.php">TERMINAL</a></li>
				...
				<button type = "button" class = "btn btn-primary" id = "btn_search" style="margin-left:.5em; padding:2px;  padding-left:10px; padding-right:10px; font-size:1.5vw"><span class="ion-ios-search"></span></button>
				<button type = "button" class = "btn btn-warning" id = "reset" style="margin-left:0em; padding:2px;  padding-left:10px; padding-right:10px; font-size:1.5vw"><span class="ion-android-refresh"></span></button>
            <h3 style="margin-left:2em;font-family: 'Source Sans Pro';">BUS REPORT</h3>
        </ul>
    </div>
