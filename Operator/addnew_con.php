<?php
    ...
    mysqli_query($conn,"INSERT INTO user_con(user_id, u_name, l_name, f_name, m_intl, sufx, sex, ter_id, pass, cont_no, stat_id, emp_date) VALUES ('$id', '$u_name', '$l_name', '$f_name', '$m_intl', '$sufx', '$sex', '$ter_id', '".md5($pass)."', '$cont_no', '$stat_id', '$emp_date')");
