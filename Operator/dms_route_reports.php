...
<div class="row">
	...
	<div>
		...
		<li  style="font-family: 'Source Sans Pro';"><a href="dms_reports.php">BUS</a></li>
            ...
            <li style="left:.1em;font-family: 'Source Sans Pro';"><a href="dms_route_reports.php">ROUTE</a></li>
            ...
            <h3 style="margin-left:6em;font-family: 'Source Sans Pro';">ROUTE REPORT</h3>
        </ul>
    </div>
				...
				<table class="table table-striped table-bordered table-hover"  >
						...
						<tbody style="display: block;overflow:auto; width: 100%;height: 550px; word-break: break-word; scrollbar-width: none; border-bottom:1px solid white">
							<?php
								...
								$query=mysqli_query($conn,"SELECT  CONCAT(f_descrip,' - ',l_descrip) as name
								FROM route_details a,  que_details b
