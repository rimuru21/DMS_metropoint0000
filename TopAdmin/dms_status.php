    ...
    <div class="col-md-10">
        <div >
            <ul class="menu-bar">
                ...
                <h3 style="left:20em;font-family: 'Source Sans Pro';">BUS AND USER DETAILS</h3>
            </ul>
        </div>
        ...
        <div class="col-md-6" style="left:-5.5em">
            ...
            <div class="" style=" width:50.1%; ">
                <span class="pull-right"><a style="padding:8px; border-radius:4px; margin-bottom:.5em; "href="#addnew_user_stat" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Status</a></span>
				    ...
				    <table class="table table-striped table-bordered table-hover" >
						...
						<tbody style="display: block;overflow:auto; width: 100%;height: 405px; word-break: break-word; scrollbar-width: none;border-bottom:1px solid white ">
							<?php
								...
								$query=mysqli_query($conn,"select * from `user_stat` ORDER BY stat_id desc");
								while($row=mysqli_fetch_array($query)){
									?>
									<tr style="border-bottom:1px solid white;margin-bottom:5px">
										<td style="width:30%"><?php echo $row['descrip']; ?></td>
										<td style="width:10%">
											
											<a style="font-size:1.5vw" href="#edit_stat<?php echo $row['stat_id']; ?>" data-toggle="modal" class="btn "><span class="ion-edit"></span> </a> |
											<a style="font-size:1.5vw" href="#del_stat<?php echo $row['stat_id']; ?>" data-toggle="modal" class="btn "><span class="ion-trash-b"></span></a>
											<?php include('action/action_status.php'); ?>
										</td>
									</tr>
									<?php
								}
...
<div class="col-md-6"style="margin-left:37.9em; top:-37.2em;">
            <div class="container" style="padding-top:0em;">
            <div style=" "></div>
            <div class="" style=" width:50.1%; ">
            <span class="pull-right"><a style="padding:8px; border-radius:4px; margin-bottom:.5em; "href="#addnew_stat" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Status</a></span>
                <div style="height:10px; "></div>
				<table class="table table-striped table-bordered table-hover" >
						<thead style="display: block; overflow: hidden; word-break: break-word;border-bottom:1px solid white;padding-bottom:10px; padding-top:10px">
								<th style="width:30%">BUS STATUS</th>
								<th style="width:10%">ACTION</th>
						</thead>
						<tbody style="display: block;overflow:auto; width: 100%;height: 405px; word-break: break-word; scrollbar-width: none;border-bottom:1px solid white ">
							<?php
								...
								$query=mysqli_query($conn,"select * from `bus_stat` ORDER BY bus_stat_id desc");
								while($row=mysqli_fetch_array($query)){
									?>
									<tr style="border-bottom:1px solid white;margin-bottom:5px">
										<td style="width:30%"><?php echo $row['descrip']; ?></td>
										<td style="width:10%">
											...
											<a style="font-size:1.5vw" href="#edit_bus_stat<?php echo $row['bus_stat_id']; ?>" data-toggle="modal" class="btn "><span class="ion-edit"></span> </a> |
											<a style="font-size:1.5vw" href="#del_bus_stat<?php echo $row['bus_stat_id']; ?>" data-toggle="modal" class="btn "><span class="ion-trash-b"></span></a>
											<?php include('action/action_status.php'); ?>
										</td>
									</tr>
									<?php
		...
		<?php include('modal/add_bus_stat_modal.php'); ?>
</div>
</div>
	...
	<div class="row" style="margin-top:13.2em;" >
