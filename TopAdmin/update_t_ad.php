<?php
    ...
    mysqli_query($conn,"UPDATE `user_t_ad` SET `user_id`='$user_id', `u_name`='$u_name',`l_name`='$l_name',`f_name`='$f_name',`m_intl`='$m_intl',`sufx`='$sufx',`sex`='$sex',`ter_id`='$ter_id',`cont_no`='$cont_no',`stat_id`='$stat_id' WHERE `user_id`= '$user_id' AND `t_ad_id`= '$t_ad_id' ");
