...
<div class="row">
	...
	<div>
        ...
        <li  style="font-family: 'Source Sans Pro';"><a href="user_t_admin.php">Top Admin</a></li>
                ...
                <h3 style="left:2em; font-family: 'Source Sans Pro';">Manager Details</h3>
        </ul>
	</div>
	...
	<div class="" style=" width:90%;">
		<div style="height:10px" ></div>
				<table class="table table-striped table-bordered table-hover" id="myTable" >
                        ...
                        <?php
								include('conn.php');
								$query=mysqli_query($conn,"SELECT   d.user_id as user_id, a.man_id as man_id, a.l_name as l_name, a.f_name as f_name, a.sufx as sufx, a.m_intl as m_intl, CONCAT(a.l_name,', ',a.f_name,' ' ,a.sufx,' ',a.m_intl,'.') as name,  a.u_name as u_name, b.ter_id as ter_id, b.descrip as ter_descrip, c.stat_id as stat_id, c.descrip as stat_descrip, a.sex as sex, a.cont_no as cont_no
								FROM user_man a, ter_details b, user_stat c, user d
								...
								while($row=mysqli_fetch_array($query)){
									...
									<tr style="border-bottom:1px solid white;margin-bottom:5px;height:50px">
										...
										<td style="width:9%; text-align:center">
                                            <a style="font-size:1.5vw" href="#view_user<?php echo $row['man_id']; ?>" data-toggle="modal" class="btn "><span class="ion-eye"></span> </a> |
											<a style="font-size:1.5vw" href="#edit_user<?php echo $row['man_id']; ?>" data-toggle="modal" class="btn "><span class="ion-edit"></span> </a> |
											<a style="font-size:1.5vw" href="#del_user<?php echo $row['man_id']; ?>" data-toggle="modal" class="btn "><span class="ion-trash-b"></span></a>
          ...
          <div class="row">
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('user_id') AS TotalDri FROM user WHERE type_id = 4;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('man_id') AS TotalCon FROM user_man WHERE stat_id = 1;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('man_id') AS TotalCon FROM user_man WHERE stat_id = 2;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Casual</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('man_id') AS TotalCon FROM user_man WHERE stat_id = 3;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Terminated</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('man_id') AS TotalCon FROM user_man WHERE stat_id = 4;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Suspended</h4>
