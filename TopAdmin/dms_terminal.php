    ...
    <div class="col-md-2" style="margin-top:7em; witdth:90%;height:330px" >
        <div class="col-md-6" style="left:-5.5em">
            ...
            <div class="" style=" width:50.1%; ">
                <span class="pull-right"><a style="padding:8px; border-radius:4px; margin-bottom:.5em; "href="#addnew_ter" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Terminal</a></span>
        ...
        <div style=" "></div>
            <div class="" style=" width:50.1%; ">
            <span class="pull-right"><a style="padding:8px; border-radius:4px; margin-bottom:.5em; "href="#addnew_route" data-toggle="modal" class="btn btn-primary"><span class="ion-plus-round" style="padding-right:.5em"></span> Add Route</a></span>
                <div style="height:10px; "></div>
				    <table class="table table-striped table-bordered table-hover" >
						<thead style="display: block; overflow: hidden; word-break: break-word;border-bottom:1px solid white;padding-bottom:10px; padding-top:10px">
