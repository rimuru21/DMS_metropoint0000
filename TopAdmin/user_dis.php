...
<div class="row">
	...
	<div>
        <ul class="menu-bar">
                ...
                <li  style="font-family: 'Source Sans Pro';left:.4em"><a href="user_sup.php">Supervisor</a></li>
                <li  style="font-family: 'Source Sans Pro';left:0em"><a href="user_man.php">Manager</a></li>
                <li  style="font-family: 'Source Sans Pro';left:-.6em"><a href="user_op.php">Operator</a></li>
                <li  style="font-family: 'Source Sans Pro';left:-1em"><a href="user_dis.php">Dispatcher</a></li>
                <li  style="font-family: 'Source Sans Pro';left:-1.5em"><a href="user_dri.php">Driver</a></li>
                <li  style="font-family: 'Source Sans Pro';left:-2em"><a href="user_con.php">Conductor</a></li>
					<input style="width:200px;margin-left:1em" type = "text" class = "form-control" id="myInput" onkeyup="myFunction()" placeholder="Type name...">
                ...
                <h3 style="left:2em; font-family: 'Source Sans Pro';">Dispatcher Details</h3>
        </ul>
	</div>
		...
		<div style="height:10px" ></div>
				<table class="table table-striped table-bordered table-hover" id="myTable" >
                        ...
                        <?php
								...
								$query=mysqli_query($conn,"SELECT   d.user_id as user_id, a.dispt_id as dispt_id, a.l_name as l_name, a.f_name as f_name, a.sufx as sufx, a.m_intl as m_intl, CONCAT(a.l_name,', ',a.f_name,' ' ,a.sufx,' ',a.m_intl,'.') as name,  a.u_name as u_name,  b.ter_id as ter_id, b.descrip as ter_descrip, c.stat_id as stat_id, c.descrip as stat_descrip, a.sex as sex, a.cont_no as cont_no
								FROM user_dispt a, ter_details b, user_stat c, user d
								...
								while($row=mysqli_fetch_array($query)){
									...
									<tr style="border-bottom:1px solid white;margin-bottom:5px;height:50px">
										...
										<td style="width:9%; text-align:center">
                                            <a style="font-size:1.5vw" href="#view_user<?php echo $row['dispt_id']; ?>" data-toggle="modal" class="btn "><span class="ion-eye"></span> </a> |
											<a style="font-size:1.5vw" href="#edit_user<?php echo $row['dispt_id']; ?>" data-toggle="modal" class="btn "><span class="ion-edit"></span> </a> |
											<a style="font-size:1.5vw" href="#del_user<?php echo $row['dispt_id']; ?>" data-toggle="modal" class="btn "><span class="ion-trash-b"></span></a>
          ...
          <div class="row">
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('user_id') AS TotalDri FROM user WHERE type_id = 6;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('dispt_id') AS TotalCon FROM user_dispt WHERE stat_id = 1;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('dispt_id') AS TotalCon FROM user_dispt WHERE stat_id = 2;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Casual</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('dispt_id') AS TotalCon FROM user_dispt WHERE stat_id = 3;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Terminated</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('dispt_id') AS TotalCon FROM user_dispt WHERE stat_id = 4;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Suspended</h4>
