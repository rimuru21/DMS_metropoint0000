...
<div class="row">
	...
	<div>
        <ul class="menu-bar">
                ...
                <h3 style="left:2em; font-family: 'Source Sans Pro';">Operator Details</h3>
        </ul>
	</div>
		...
		<div style="height:10px" ></div>
				<table class="table table-striped table-bordered table-hover" id="myTable"  >
                        ...
                        <?php
								...
								$query=mysqli_query($conn,"SELECT   d.user_id as user_id, a.opt_id as opt_id, a.l_name as l_name, a.f_name as f_name, a.sufx as sufx, a.m_intl as m_intl, CONCAT(a.l_name,', ',a.f_name,' ' ,a.sufx,' ',a.m_intl,'.') as name,  a.u_name as u_name, b.ter_id as ter_id, b.descrip as ter_descrip, c.stat_id as stat_id, c.descrip as stat_descrip, a.sex as sex, a.cont_no as cont_no
								FROM user_opt a, ter_details b, user_stat c, user d
          ...
          <div class="row">
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('user_id') AS TotalDri FROM user WHERE type_id = 5;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('opt_id') AS TotalCon FROM user_opt WHERE stat_id = 1;");
											while($row=mysqli_fetch_array($query)){
								?>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('opt_id') AS TotalCon FROM user_opt WHERE stat_id = 2;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Casual</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('opt_id') AS TotalCon FROM user_opt WHERE stat_id = 3;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Terminated</h4>
                    ...
                    <div class="small-box bg-aqua"  style="height:125px;padding-top:1.1em">
                        <div class="inner">
								<?php
									include('conn.php');                
									$query=mysqli_query($conn,"SELECT COUNT('opt_id') AS TotalCon FROM user_opt WHERE stat_id = 4;");
											while($row=mysqli_fetch_array($query)){
								?>
                        	<h3><?php echo $row['TotalCon']; ?></h3>
							<h4>Suspended</h4>
