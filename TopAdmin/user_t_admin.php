...
<div class="row">
	...
	<div>
        <ul class="menu-bar">
                ...
                <h3 style="left:2em; font-family: 'Source Sans Pro';">Top Admin Details</h3>
        </ul>
	</div>
								...
								while($row=mysqli_fetch_array($query)){
									...
									<tr class="<?php echo $row['t_ad_id']; ?>" style="border-bottom:1px solid white;margin-bottom:5px;height:50px">
										...
										<td style="width:9%; text-align:center">
                                            <a style="font-size:1.5vw" href="#view_user<?php echo $row['t_ad_id']; ?>" data-toggle="modal" class="btn "><span class="ion-eye"></span> </a> |
											<a style="font-size:1.5vw" href="#edit_user<?php echo $row['t_ad_id']; ?>" data-toggle="modal" class="btn "><span class="ion-edit"></span> </a> |
											<a style="font-size:1.5vw" href="#del_user<?php echo $row['t_ad_id']; ?>" data-toggle="modal" class="btn "><span class="ion-trash-b"></span></a>
